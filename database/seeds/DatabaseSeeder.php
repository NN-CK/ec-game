...
軍事技術がさらに進化し、兵士の体を機械化した強力な人間兵器同士が戦う世界で物語が展開する。",
        ...
        DB::table('games')->insert([$ps4_mgs5tpp, $ps4_codbo3,$ps4_darksouls3,$ps4_overwatch]);
    }
}
